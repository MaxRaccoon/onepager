                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li {{ (Request::is('admin/users') ? 'class="active"' : '') }}>
                            <a href="{{ url ('admin/users') }}"><i class="fa fa-bar-chart-o fa-fw"></i> Пользователи</a>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li {{ (Request::is('admin/technologies') ? 'class="active"' : '') }}>
                            <a href="{{ url ('admin/technologies') }}"><i class="fa fa-cog" aria-hidden="true"></i> Технологии</a>
                        </li>
